...
boxplot(f.meta$C_percent~f.meta$Depth+f.meta$Treatment,las=2, xlab=NULL,cex.names=0.1,main="Carbon", ylab="carbon percent", names=c("NT 0-5cm","NT 5-10cm","NT 10cm-Ap","CT 0-5cm","CT 5-10cm","CT 10cm-Ap","Org 0-5cm", "Org 5-10cm","Org 10cm-Ap"), par(cex.axis=0.8))

  boxplot(f.meta$N_percent~f.meta$Depth+f.meta$Treatment,las=2, xlab=NULL,cex.names=0.1,main="Nitrogen", ylab="nitrogen percent", names=c("NT 0-5cm","NT 5-10cm","NT 10cm-Ap","CT 0-5cm","CT 5-10cm","CT 10cm-Ap","Org 0-5cm", "Org 5-10cm","Org 10cm-Ap"), par(cex.axis=0.8))

summary(aov(f.meta$C_percent~f.meta$Treatment*f.meta$Depth))
TukeyHSD(aov(f.meta$C_percent~f.meta$Treatment*f.meta$Depth))

summary(aov(f.meta$N_percent~f.meta$Treatment*f.meta$Depth))
TukeyHSD(aov(f.meta$N_percent~f.meta$Treatment*f.meta$Depth))
